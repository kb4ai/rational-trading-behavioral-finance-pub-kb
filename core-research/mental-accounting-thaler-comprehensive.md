...
* **Denomination as fourth non-fungibility axis**: Beyond Thaler's three accounts (current income, current wealth, future income), denomination choice creates a fourth axis of non-fungibility. The same portfolio valued as "0.1 BTC" vs "$10,000" vs "7.5 oz gold" activates different reference frames, risk perceptions, and action thresholds. Hedonic editing rules (Section 2.3) predict agents will select denominations that optimize subjective P&L experience — segregating gains and integrating losses via denomination switching. See: [multi-denomination-portfolio-valuation.md](multi-denomination-portfolio-valuation.md) and [denomination-invariant-evaluation.md](../debiasing-frameworks/denomination-invariant-evaluation.md)

---

*Cross-references: [multi-denomination-portfolio-valuation.md](multi-denomination-portfolio-valuation.md) | [fungibility-asset-transformation-rational-framework.md](fungibility-asset-transformation-rational-framework.md) | [mental-accounting-cognitive-science-parallels.md](mental-accounting-cognitive-science-parallels.md) | [behavioral-biases-multi-paper-synthesis.md](behavioral-biases-multi-paper-synthesis.md) | [BIBLIOGRAPHY.md](../BIBLIOGRAPHY.md) | [KB-ROUTING.md](../KB-ROUTING.md)*
