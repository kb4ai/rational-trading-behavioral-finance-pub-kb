...
|----------|-------|--------|
| **Kahneman & Tversky (1979)** | Prospect Theory: Analysis of Decision under Risk | DOI needed |
| **Tversky & Kahneman (1973)** | Availability Heuristic and Probability Judgment | DOI needed |
| **Tversky & Kahneman (1974)** | Judgment under Uncertainty: Heuristics and Biases | DOI needed |
| **Shefrin & Statman (1985)** | The Disposition to Sell Winners Too Early and Ride Losers Too Long | DOI needed |
| **Fischhoff (1975)** | Hindsight ≠ Foresight: The Effect of Outcome Knowledge | DOI needed |
| **Thaler & Johnson (1990)** | Gambling with the House Money and Trying to Break Even | [10.1287/mnsc.36.6.643](https://doi.org/10.1287/mnsc.36.6.643) — now in Primary Research |

## Additional Referenced Studies

Papers cited in research artifacts for supporting evidence.

### Cognitive Bias Research

| Citation | Finding | Source Location |
|----------|---------|-----------------|
| **Quattrone et al. (1981)** | Simple warnings about anchoring bias do not decrease anchoring effects | research-artifacts/ |
| **Pohl et al. (1996)** | Warnings about hindsight bias do not reduce the bias | research-artifacts/ |
| **West, Meserve & Stanovich (2012)** | Higher cognitive ability associated with larger bias blind spot | research-artifacts/ |

### Autism and Decision-Making

| Citation | Finding | Source Location |
|----------|---------|-----------------|
| **Farmer, Baron-Cohen & Skylark (2017)** | People with autism make more consistent decisions with decoy options. *Psychological Science* | research-artifacts/ |
| **Pellicano & Burr (2012)** | Hypopriors theory: Autism characterized by perception driven by sensory input with less background expectation influence | research-artifacts/ |

### Trading Behavior

| Citation | Finding | Source Location |
|----------|---------|-----------------|
| **Thoma et al. (2015)** | Traders score significantly higher on Cognitive Reflection Test than non-trading bankers. *PLOS ONE* | research-artifacts/ |
| **Rabin & Vayanos (2010)** | Gambler's fallacy after short streaks, hot-hand fallacy as streaks lengthen | research-artifacts/ |
| **Guenzel (2020)** | Sunk cost increase reduces divestiture rates by 8-9% (Wharton) | research-artifacts/ |
| **Gine & Goldberg (2018)** | 42% retention rate for objectively inferior positions (endowment effect) | research-artifacts/ |

### Social Media and Retail Trading

| Citation | Finding | Source Location |
|----------|---------|-----------------|
| **Kim, Lee & Kauffman (2023)** | Reddit social posts drove GameStop meme stock trading behavior | research-artifacts/ |
| **Warkulat & Pelster (2024)** | Positions at peak WallStreetBets attention realize -8.5% holding period returns | research-artifacts/ |
| **Kobilov (Harvard)** | Social media exacerbates behavioral biases; retail traders underperform on high social media discussion days | research-artifacts/ |

### Market Microstructure

| Citation | Finding | Source Location |
|----------|---------|-----------------|
| **Osler (Federal Reserve)** | Stop-loss orders cluster at round numbers; create predictable price cascades | research-artifacts/ |
| **Easley, López de Prado & O'Hara** | VPIN produced signals >1 hour before 2010 Flash Crash | research-artifacts/ |
| **Norges Bank (2025)** | Algorithms exhibit significantly weaker disposition effect than humans | research-artifacts/ |

## Institutional Reports

| Source | Finding | Year |
|--------|---------|------|
| **Ontario Securities Commission** | Traders following finfluencer advice 12.2x more likely to be scammed | 2024 |
...
| Paper | Repository Locations |
|-------|---------------------|
| De Martino et al. (2008) | `core-research/de-martino-2008-framing-effects-autism-explained.md`, `core-research/behavioral-biases-multi-paper-synthesis.md`, `README.md`, `KB-ROUTING.md` |
| Grinblatt et al. (2012) | `core-research/behavioral-biases-multi-paper-synthesis.md`, `README.md`, `KB-ROUTING.md` |
| Odean (1998) | `core-research/behavioral-biases-multi-paper-synthesis.md`, `KB-ROUTING.md`, `core-research/mental-accounting-thaler-comprehensive.md` |
| Barber & Odean (2000) | `core-research/behavioral-biases-multi-paper-synthesis.md` |
| Thaler (1985) | `core-research/behavioral-biases-multi-paper-synthesis.md`, `KB-ROUTING.md`, `core-research/mental-accounting-thaler-comprehensive.md` |
| Thaler (1999) | `core-research/mental-accounting-thaler-comprehensive.md` |
| Thaler & Johnson (1990) | `core-research/mental-accounting-thaler-comprehensive.md` |
| Prelec & Loewenstein (1998) | `core-research/mental-accounting-thaler-comprehensive.md` |
| Arkes & Blumer (1985) | `core-research/mental-accounting-thaler-comprehensive.md` |
| Benartzi & Thaler (1995) | `core-research/mental-accounting-thaler-comprehensive.md` |
| Paul, Parker & Dommer (2023) | `core-research/mental-accounting-thaler-comprehensive.md` |
| Samuelson & Zeckhauser (1988) | `core-research/behavioral-biases-multi-paper-synthesis.md`, `KB-ROUTING.md` |
| Yafai et al. (2014) | `core-research/behavioral-biases-multi-paper-synthesis.md` |
| Prelec & Simester (2001) | `core-research/mental-accounting-thaler-comprehensive.md`, `core-research/fungibility-asset-transformation-rational-framework.md` |
| Rabin & Weizsäcker (2009) | `core-research/fungibility-asset-transformation-rational-framework.md` |
| Gul & Pesendorfer (2001) | `core-research/fungibility-asset-transformation-rational-framework.md` |
| Kőszegi & Matejka (2020) | `core-research/fungibility-asset-transformation-rational-framework.md` |
| Barberis, Huang & Santos (2001) | `core-research/fungibility-asset-transformation-rational-framework.md` |
| Grinblatt & Han (2005) | `core-research/fungibility-asset-transformation-rational-framework.md` |
| Knutson et al. (2007) | `core-research/fungibility-asset-transformation-rational-framework.md` |
...
*This bibliography is maintained as part of the rational-trading-behavioral-finance knowledge base. For contribution guidelines, see CLAUDE.md.*
